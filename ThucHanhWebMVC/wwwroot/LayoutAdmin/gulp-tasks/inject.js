...
gulp.task('injectAssets', function () {
    return gulp.src(["./**/*.html"])
        .pipe(inject(gulp.src([
            './LayoutAdmin/assets/vendors/mdi/css/materialdesignicons.min.css',
            './LayoutAdmin/assets/vendors/css/vendor.bundle.base.css',
            './LayoutAdmin/assets/vendors/js/vendor.bundle.base.js',
        ], {
            read: false
        }), {
            name: 'plugins',
        ...
        .pipe(inject(gulp.src([
            // './LayoutAdmin/assets/css/shared/style.css',
            './LayoutAdmin/assets/js/off-canvas.js',
            './LayoutAdmin/assets/js/hoverable-collapse.js',
            './LayoutAdmin/assets/js/misc.js',
        ], {
            read: false
        }), {
            relative: true
...
gulp.task('replacePath', function () {
    var replacePath1 = gulp.src('pages/**/*.html', {
        ...
        .pipe(replace('src="LayoutAdmin/assets/images/', 'src="../../LayoutAdmin/assets/images/'))
